...
--
-- Host: localhost:3307
-- Generation Time: Jan 24, 2026 at 07:03 PM
...
CREATE TABLE `recursos` (
  ...
  `deshabilitado_por_zona` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `recursos` (`id`, `zona_id`, `nombre`, `tipo`, `descripcion`, `ubicacion`, `imagen_url`, `cantidad_total`, `estado`, `eliminado`, `deshabilitado_por_zona`, `mantenimiento_inicio`, `mantenimiento_fin`, `creado_en`) VALUES
(1, 1, 'Futbolín A', 'JUEGO', 'Mesa de futbolín', 'Chill Zone', '/static/img/resources/Chill_zone_futbolin_A.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(2, 1, 'Futbolín B', 'JUEGO', 'Mesa de futbolín', 'Chill Zone', '/static/img/resources/Chill_zone_futbolin_B.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(3, 1, 'Mesa de Ping Pong', 'MESA', 'Mesa oficial de ping pong', 'Chill Zone', '/static/img/resources/Chill_zone_ping_pong.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(4, 1, 'Mesa Juegos de Mesa', 'MESA', 'Mesa con juegos de mesa', 'Chill Zone', '/static/img/resources/Coworking_B.jpg', 1, 'DISPONIBLE', 1, 0, NULL, NULL, '2025-11-04 02:42:05'),
(5, 2, 'Coworking Sala 1', 'SALA', 'Sala para 4 personas', 'Coworking', '/static/img/resources/Coworking_A.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(6, 2, 'Coworking Sala 2', 'SALA', 'Sala para 4 personas', 'Coworking', '/static/img/resources/Coworking_B.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(7, 2, 'Coworking Sala 3', 'SALA', 'Sala para 6 personas', 'Coworking', '/static/img/resources/Coworking_C.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(8, 2, 'Coworking Sala 4', 'SALA', 'Sala para 6 personas', 'Coworking', '/static/img/resources/Coworking_D.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2025-11-04 02:42:05'),
(9, 3, 'Cancha Fútbol', 'JUEGO', NULL, 'A lado  del coliseo', '/static/uploads/recursos/4485e3dc539a434497c473b19ba41ede_Zona_canchas.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2026-01-24 16:48:58'),
(10, 3, 'Cancha Básquet', 'JUEGO', NULL, 'En el coliseo', '/static/uploads/recursos/0aaf2ed9d5324f1c9d7497c01005845c_cancha_basquet.jpg', 1, 'DISPONIBLE', 0, 0, NULL, NULL, '2026-01-24 16:50:04');
...
(13, 25, 3, '2026-01-24 18:17:24'),
(14, 25, 4, '2026-01-24 18:17:24'),
(15, 28, 3, '2026-01-24 18:41:37');
...
INSERT INTO `zonas` (`id`, `nombre`, `descripcion`, `imagen_url`, `eliminado`, `creado_en`) VALUES
(1, 'Chill Zone', 'Espacio de recreación y descanso', '/static/img/resources/Chill_Zone.jpg', 0, '2025-11-04 02:42:05'),
(2, 'Coworking', 'Espacio de estudio y trabajo colaborativo', '/static/img/resources/CoWorkZone.jpg', 0, '2025-11-04 02:42:05'),
(3, 'Canchas', 'Espacio para hacer deporte con tus amigos', '/static/uploads/zonas/ee9e47bd66854a918db4ebec0968db69_Zona_canchas.jpg', 0, '2026-01-24 16:47:34');
...
ALTER TABLE `recursos`
  ...
  ADD KEY `idx_recursos_deshabilitado_zona` (`deshabilitado_por_zona`);
...
ALTER TABLE `zonas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nombre` (`nombre`),
  ADD KEY `idx_zonas_eliminado` (`eliminado`);
